# -*- coding: utf-8 -*-
"""
Created on Wed Feb 20 23:13:08 2019
...
def bceloss(w1,w2,w_end,b1,b2,b_end):
...
gw1 = grad(bceloss,0)
gw2 = grad(bceloss,1)
gw_end = grad(bceloss,2)
gb1 = grad(bceloss,3)
gb2 = grad(bceloss,4)
gb_end = grad(bceloss,5)

lossfunction = np.array([0])

for i in range(1,it+1):
    gradw1 = gw1(w1,w2,w_end,b1,b2,b_end)
    gradw2 = gw2(w1,w2,w_end,b1,b2,b_end)
    gradw_end = gw_end(w1,w2,w_end,b1,b2,b_end)
    gradb1 = gb1(w1,w2,w_end,b1,b2,b_end)
    gradb2 = gb2(w1,w2,w_end,b1,b2,b_end)
    gradb_end = gb_end(w1,w2,w_end,b1,b2,b_end)
    ...
    loss = bceloss(w1,w2,w_end,b1,b2,b_end)
...
outputlayer = sigmoid(layer2,w_end,b_end)
